...
function addCarrito(valor) {
  ...
  var coDRef  = document.getElementById("coDRefMas"+valor).value;
 
  var cantItem  = document.getElementById("cantItemMas"+valor).value;
  ...
  var url = "<?= $BD;?>procesoCarrito.php?coDRef="+encodeURI(coDRef)+"&cantItem="+encodeURI(cantItem);
